...
class Config(BaseModel):
    ...
    def load_config(cls) -> "Config":
        ...
        return Config(
            ...
            developer_logger=cls.__check_true(
                data_env.get("DEVELOPER_LOGGER", False),
            ),
            developer_mode=cls.__check_true(
                data_env.get("DEVELOPER_MODE"),
            ),
            debug=cls.__check_true(
                data_env.get("DEBUG"),
            ),
            ...
            development_routers=cls.__check_true(
                value=data_env.get("DEVELOPMENT_ROUTERS", False),
            ),
        )
